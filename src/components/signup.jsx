    ...
    return( 
        <>
           ...
           <label htmlFor="name">Name<span className="text-red-600"> *</span></label>
            <input onChange={(e)=>setusername(e.target.value)} className="px-1 border shadow-md rounded-md outline-none" type="text" />
            ...
            <input onChange={(e)=>setphone(e.target.value)} className="px-1 border shadow-md rounded-md outline-none" type="text" />
            <label htmlFor="password">Password<span className="text-red-600"> *</span></label>
            <input onChange={(e)=>setpassword(e.target.value)} className="px-1 border shadow-md rounded-md outline-none" type="text" />
            <label htmlFor="confirm password">Confirm Password<span className="text-red-600"> *</span></label>
            <input onChange={(e)=>confirmpwd(e.target.value)} className="px-1 border shadow-md rounded-md outline-none" type="password" />
